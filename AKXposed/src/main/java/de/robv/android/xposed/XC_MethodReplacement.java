...
/**
 * A special case of {@link XC_MethodHook} which completely replaces the
 * original method.
 */
public abstract class XC_MethodReplacement extends XC_MethodHook {
	 ...
	 * @throws Throwable
	 *             Anything that is thrown by the callback will be passed on to
	 *             the original caller.
	 */
	 ...
	 *
	 * @param result
	 *            The value that should be returned to callers of the hooked
	 *            method.
	 */
	...
	/**
	 * Like {@link #returnConstant(Object)}, but allows to specify a priority
	 * for the callback.
	 *
	 * @param priority
	 *            See {@link XCallback#priority}.
	 ...
	 *            method.
	 */
	public static XC_MethodReplacement returnConstant(int priority,
			final Object result) {
