...
public final class XSharedPreferences implements SharedPreferences {
	...
	public XSharedPreferences(String packageName, String prefFileName) {
		mFile = XposedInit.getSharedPreferences(packageName, prefFileName);
		mFilename = mFile.getAbsolutePath();
		startLoadFromDisk();
	}
	...
	private void loadFromDiskLocked() {
		...
		try {
			result = SELinuxHelper.getAppDataFileService().getFileInputStream(
					mFilename, mFileSize, mLastModified);
	...
	public synchronized boolean hasFileChanged() {
		try {
			FileResult result = SELinuxHelper.getAppDataFileService().statFile(
					mFilename);
